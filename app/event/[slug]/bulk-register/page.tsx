...
export default async function BulkRegisterPage({ params }: PageProps) {
    ...
    // Check registration window/status — mirrors app/tournament/[id]/register's own
    // guard. The API route enforces this too (a direct POST can't bypass it), but
    // without this the form would stay live and misleadingly usable here.
