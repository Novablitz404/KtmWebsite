                        ...
                        <form onSubmit={handlePromoteClubMaster} className="p-6 space-y-4">
                            ...
                            <div className="flex gap-3 pt-2">
                                ...
                                <button
                                    ...
                                    className="flex-1 px-4 py-2 bg-orange-600 text-white rounded-xl font-medium hover:bg-orange-700 disabled:opacity-70 disabled:cursor-not-allowed transition-colors shadow-sm flex items-center justify-center gap-2"
                                >
                                    {isLoading ? (
                                        <>
