...
export default function RegisterConfirm({
    ...
    return (
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden max-w-2xl w-full mx-auto">
            ...
            <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 border-b border-slate-700 p-8 text-white relative overflow-hidden">
                ...
                <div className="relative z-10">
                    <h2 className="text-2xl font-bold tracking-tight mb-6">Confirm Registration</h2>

                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-y-4 gap-x-8 text-sm">
                        <div>
                            <p className="text-slate-400 text-xs uppercase tracking-wider font-semibold mb-1">Athlete</p>
                            <p className="font-semibold text-white text-base">{user.name}</p>
                        </div>
                        <div>
                            <p className="text-slate-400 text-xs uppercase tracking-wider font-semibold mb-1">Club</p>
                            <p className="font-semibold text-white text-base">{user.clubName}</p>
                        </div>
                        <div>
                            <p className="text-slate-400 text-xs uppercase tracking-wider font-semibold mb-1">Belt</p>
                            <p className="font-semibold text-white text-base">{user.belt}</p>
                        </div>
                        <div>
                            <p className="text-slate-400 text-xs uppercase tracking-wider font-semibold mb-1">Division</p>
