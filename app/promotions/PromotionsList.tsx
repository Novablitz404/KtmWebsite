...
import { Calendar, MapPin, ChevronRight, Eye, X, DollarSign, Users, Copy, Check } from 'lucide-react'
...
function PromotionDetailsModal({ test, onClose }: { test: PromotionTest; onClose: () => void }) {
    return (
                    ...
                    <div className="p-6 space-y-5 max-h-[70vh] overflow-y-auto">
                        <DetailRow icon={<Calendar className="w-4 h-4" />} label="Test Date">
                            <span className="text-sm font-medium text-gray-900">
                                {new Date(test.testDate).toLocaleDateString('en-US', { weekday: 'long', month: 'short', day: 'numeric', year: 'numeric' })}
                            </span>
                        </DetailRow>
                        ...
                        {test.description && (
                            <DetailRow icon={<Calendar className="w-4 h-4" />} label="Description">
                                <span className="text-sm text-gray-700">{test.description}</span>
                            </DetailRow>
                        )}
