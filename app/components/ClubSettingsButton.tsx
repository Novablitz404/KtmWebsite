...
import { updateClubSettings } from '@/app/actions'
import { toast } from 'sonner'
import { useRouter } from 'next/navigation'

interface ClubSettingsButtonProps {
    clubId: string
...
export default function ClubSettingsButton({
    clubId,
    clubLogo,
    address,
    phone,
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    <div className="relative bg-white rounded-2xl shadow-xl w-full max-w-md p-6 animate-in fade-in zoom-in-95 duration-200 max-h-[90vh] overflow-y-auto">
                        <div className="flex justify-between items-start mb-6">
                            <div>
                                <h3 className="text-xl font-bold text-gray-900">Club Settings</h3>
                                <p className="text-gray-500 text-sm mt-1">Update your club profile</p>
                            </div>
                            <button
