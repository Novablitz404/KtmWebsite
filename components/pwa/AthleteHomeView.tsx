...
interface AthleteHomeViewProps {
    dbUser: any
    clerkUser: any
        ...
        <main className="min-h-[calc(100vh-80px)] bg-gray-50 pb-20">
            ...
            <div className="px-4 mt-6">
                ...
                <div className="space-y-3">
                    ...
                    {/* Note: Profile link removed (handled by tabs) or can just switch tab? 
                        For now keeping it but it might cause navigation. 
                        Ideally we pass a callback "onNavigateToProfile" if we want to switch tabs internally.
                        But leaving as Link defaults to soft nav or full nav which is fine for now.
                     */}
                </div>
            </div>
