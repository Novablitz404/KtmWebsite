    ...
    if (isEditing) {
        return (
            <div className="bg-white h-full flex flex-col">
                ...
                <div className="bg-white border-b border-gray-200 px-4 py-3 sticky top-0 z-20 flex items-center justify-between shrink-0">
                    <button
        ...
        return (
            <div className="bg-white h-full flex flex-col">
                ...
                <div className="bg-white border-b border-gray-200 px-4 py-3 sticky top-0 z-20 flex items-center justify-between shrink-0">
                    ...
                    <h1 className="text-base font-bold text-gray-900">Edit Club Details</h1>
                    <div className="w-9" /> {/* Spacer */}
                </div>
                ...
                <div className="flex-1 overflow-y-auto p-4 pb-20">
                    <ClubEditForm
                        ...
                        onSuccess={() => setIsEditingClub(false)}
                    />
                </div>
            </div>
        )
        ...
        <div className="bg-gray-50 min-h-[calc(100vh-64px)]">
            ...
            <div className="bg-gray-50 pb-4">
                ...
                <div className="space-y-3">
                    ...
                    {/* Organization Settings (Club Master Only) */}
                    {dbUser.role === 'CLUB_MASTER' && club && (
                        <div>
                            <h3 className="px-4 text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1">Organization</h3>
                                    ...
                                    <div className="px-4 py-2.5 flex items-center justify-between w-full">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div className="text-left">
                                                <span className="text-sm font-medium text-gray-900 block">Edit Club</span>
                                                <span className="text-xs text-gray-500 block">{club.name}</span>
                                            </div>
                                        </div>
