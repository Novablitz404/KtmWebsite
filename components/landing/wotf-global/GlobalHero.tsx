...
export default function GlobalHero() {
    ...
    return (
        <section className="relative w-full h-[100dvh] min-h-[550px] flex items-center justify-center overflow-hidden bg-black">
            ...
            {/* Content */}
            <div className="relative z-10 text-center px-6 max-w-5xl mx-auto -mt-12 md:-mt-16">
                {/* Logo */}
                <div className="animate-hero-fade-in mb-5 md:mb-8">
                    <Image
                        src="/wotf-global/Wotf_logo_Final.png"
                        alt="WOTF Global Logo"
                        width={140}
                        height={140}
                        className="mx-auto w-32 h-32 sm:w-48 sm:h-48 md:w-[280px] md:h-[280px]"
                ...
                <div className="animate-hero-fade-in-delayed-1">
                    <Image
                        ...
                        width={600}
                        height={120}
                        className="mx-auto w-[180px] sm:w-[260px] md:w-[340px] lg:w-[400px] h-auto brightness-0 invert drop-shadow-lg"
                    />
                </div>

                {/* Subtitle */}
                <p className="animate-hero-fade-in-delayed-2 mt-3 md:mt-6 text-xs sm:text-base md:text-lg text-gray-300 max-w-2xl mx-auto font-light tracking-wide">
                    {t('hero.subtitle')}
                </p>
            ...
            {/* Scroll indicator */}
            <div className="absolute bottom-6 sm:bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1.5 animate-bounce">
