                ...
                <div className="px-4 pt-5 pb-4 border-b border-gray-100">
                    <div className="flex items-center gap-3 min-w-0">
                        ...
                        <div className="flex-1 min-w-0">
                            <h2 className="text-sm font-bold text-gray-900 truncate leading-tight" title={clubName}>
                                {clubName || 'Club'}
                            </h2>
                            <p className="text-[10px] text-gray-400 font-medium mt-0.5">Club Dashboard</p>
                        </div>
                    </div>
                </div>
