...
export const TENANT_BRANDING: Record<string, TenantBranding> = {
    ...
    'tap-elite': {
        name: 'Elite Taekwondo Association of the Philippines',
        slug: 'tap-elite',
        logoUrl: '/tap-elite/tap_elite_horizontal_light_transparent.png',
        logoWhiteUrl: '/tap-elite/tap_elite_horizontal_transparent.png',
        primaryColor: '#E10600',
        ...
        description: 'Tap-Elite — tournament and club management for the Elite Taekwondo Association of the Philippines. Placeholder branding, to be replaced with final logo/colors.',
        footerText: null,
    },
    'wotf-global': {
        name: 'WOTF Global',
