            ...
            <Body style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif', backgroundColor: '#f3f4f6', margin: 0, padding: 0 }}>
                <Container style={{ maxWidth: '580px', margin: '0 auto', padding: '20px' }}>
                    ...
                    <Section style={{ backgroundColor: '#ffffff', padding: '32px 24px' }}>
                        ...
                        {/* Registration Code */}
                        <Section style={{ backgroundColor: '#0f172a', borderRadius: '12px', padding: '24px', textAlign: 'center' as const, margin: '24px 0' }}>
                            <Text style={{ color: '#94a3b8', fontSize: '12px', fontWeight: 700, textTransform: 'uppercase' as const, letterSpacing: '1px', margin: '0 0 8px' }}>
                                Your Registration Code
                            </Text>
                            <Text style={{ color: '#ffffff', fontSize: '32px', fontWeight: 800, fontFamily: 'monospace', letterSpacing: '3px', margin: 0 }}>
                                {registrationCode}
                            </Text>
                        </Section>
